...
local item_list = {
    ...
    ["flying-robot-frame"] = {tier = 1, icon_name = "flying-robot-frame"},
    ["flying-robot-frame-2"] = {tier = 2, icon_name = "flying-robot-frame"},
    ["flying-robot-frame-3"] = {tier = 3, icon_name = "flying-robot-frame"},
    ["flying-robot-frame-4"] = {tier = 4, icon_name = "flying-robot-frame"},
    ["robot-tool-construction"] = {tier = 1, icon_name = "robot-tool-construction"},
    ["robot-tool-construction-2"] = {tier = 2, icon_name = "robot-tool-construction"},
    ["robot-tool-construction-3"] = {tier = 3, icon_name = "robot-tool-construction"},
    ["robot-tool-construction-4"] = {tier = 4, icon_name = "robot-tool-construction"},
    ["robot-tool-logistic"] = {tier = 1, icon_name = "robot-tool-logistic"},
    ["robot-tool-logistic-2"] = {tier = 2, icon_name = "robot-tool-logistic"},
    ["robot-tool-logistic-3"] = {tier = 3, icon_name = "robot-tool-logistic"},
    ["robot-tool-logistic-4"] = {tier = 4, icon_name = "robot-tool-logistic"},
}
