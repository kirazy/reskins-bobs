...
local items = {
    ...
    ["electric-bullet"] = {subgroup = "bullets", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("electric-bullet")}},
    ["flame-bullet"] = {subgroup = "bullets"},
    ["he-bullet"] = {subgroup = "bullets"},
    ["plasma-bullet"] = {subgroup = "bullets", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-bullet", plasma_tint)}},
    ["poison-bullet"] = {subgroup = "bullets"},
    ["uranium-bullet"] = {subgroup = "bullets", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-bullet", uranium_tint)}},
    ...
    ["electric-bullet-projectile"] = {subgroup = "projectiles", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("electric-projectile")}},
    ["flame-bullet-projectile"] = {subgroup = "projectiles"},
    ["he-bullet-projectile"] = {subgroup = "projectiles"},
    ["plasma-bullet-projectile"] = {subgroup = "projectiles", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-projectile", plasma_tint)}},
    ["poison-bullet-projectile"] = {subgroup = "projectiles"},
    ["uranium-bullet-projectile"] = {subgroup = "projectiles", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-projectile", uranium_tint)}},
    ...
    ["plasma-bullet-magazine"] = {type = "ammo", subgroup = "magazines", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("rounds-magazine")}},
    ["poison-bullet-magazine"] = {type = "ammo", subgroup = "magazines"},
    ["uranium-rounds-magazine"] = {type = "ammo", subgroup = "magazines", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("rounds-magazine")}},

    -- Warheads
    ["rocket-warhead"] = {subgroup = "warheads"},
    ["acid-rocket-warhead"] = {subgroup = "warheads"},
    ["piercing-rocket-warhead"] = {subgroup = "warheads"},
    ["electric-rocket-warhead"] = {subgroup = "warheads", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("electric-warhead")}},
    ["explosive-rocket-warhead"] = {subgroup = "warheads"},
    ["flame-rocket-warhead"] = {subgroup = "warheads"},
    ["plasma-rocket-warhead"] = {subgroup = "warheads", make_icon_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-warhead", plasma_tint)}},
    ...
    ["bob-electric-rocket"] = {type = "ammo", subgroup = "rockets", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("electric-rocket")}},
    ["bob-flame-rocket"] = {type = "ammo", subgroup = "rockets"},
    ["bob-explosive-rocket"] = {type = "ammo", subgroup = "rockets"},
    ["bob-plasma-rocket"] = {type = "ammo", subgroup = "rockets", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-rocket", plasma_tint)}},
    ...
    ["shotgun-electric-shell"] = {type = "ammo", subgroup = "shells", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("electric-shotgun-shell")}},
    ["shotgun-explosive-shell"] = {type = "ammo", subgroup = "shells"},
    ["shotgun-flame-shell"] = {type = "ammo", subgroup = "shells"},
    ["shotgun-plasma-shell"] = {type = "ammo", subgroup = "shells", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-shotgun-shell", plasma_tint)}},
    ["shotgun-poison-shell"] = {type = "ammo", subgroup = "shells"},
    ["shotgun-uranium-shell"] = {type = "ammo", subgroup = "shells", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("aura-shotgun-shell", uranium_tint)}},

    -- Laser rifle batteries
    ["laser-rifle-battery"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("b3b3b3"))}},
    ["laser-rifle-battery-ruby"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("fa1928"))}},
    ["laser-rifle-battery-sapphire"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("0033ff"))}},
    ["laser-rifle-battery-emerald"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("13e35c"))}},
    ["laser-rifle-battery-amethyst"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("d414ff"))}},
    ["laser-rifle-battery-topaz"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("f0b414"))}},
    ["laser-rifle-battery-diamond"] = {type = "ammo", subgroup = "laser-rifle-batteries", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("laser-rifle-battery", util.color("ffffff"))}},

    -- Artillery shells
    ["atomic-artillery-shell"] = {type = "ammo", subgroup = "artillery-shells", make_entity_pictures = true, icon_picture_extras = {reskins.lib.get_lit_sprite_layer("atomic-artillery-shell", uranium_tint)}},
