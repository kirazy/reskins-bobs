...
entity.folded_animation.layers[1].hr_version.filename = inputs.directory.."/graphics/entity/warfare/sniper-turret/base/animations/hr-sniper-turret-raising.png"
...
entity.preparing_animation.layers[1].hr_version.filename = inputs.directory.."/graphics/entity/warfare/sniper-turret/base/animations/hr-sniper-turret-raising.png"
...
entity.folding_animation.layers[1].hr_version.filename = inputs.directory.."/graphics/entity/warfare/sniper-turret/base/animations/hr-sniper-turret-raising.png"
