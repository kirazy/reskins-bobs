...
for name, map in pairs(tier_map) do
    ...
    remnant.animation = make_rotated_animation_variations_from_sheet (2,
    {
        layers =
        {
            ...
            {
                filename = inputs.directory.."/graphics/entity/logistics/roboport/mask/"..inputs.internal_name.."/remnants/"..inputs.internal_name.."-remnants.png",
                line_length = 1,
                width = 182,
                height = 180,
                frame_count = 1,
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/logistics/roboport/mask/"..inputs.internal_name.."/remnants/hr-"..inputs.internal_name.."-remnants.png",
                    line_length = 1,
                    width = 364,
                    height = 358,
                    frame_count = 1,
    ...
    entity.base =
    {
        layers =
        {
            ...
            {
                filename = inputs.directory.."/graphics/entity/logistics/roboport/mask/"..inputs.internal_name.."/"..inputs.internal_name.."-base.png",
                width = 143,
                height = 135,
                shift = {0.5, 0.25},
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/logistics/roboport/mask/"..inputs.internal_name.."/hr-"..inputs.internal_name.."-base.png",
                    width = 228,
                    height = 277,
                    shift = util.by_pixel(2, 7.75),
                    scale = 0.5
    ...
    entity.base_patch =
    {
        layers =
        {
            ...
            {
                filename = inputs.directory.."/graphics/entity/logistics/roboport/mask/"..inputs.internal_name.."/"..inputs.internal_name.."-base-patch.png",
                priority = "medium",
                width = 69,
                height = 50,
                frame_count = 1,
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/logistics/roboport/mask/"..inputs.internal_name.."/hr-"..inputs.internal_name.."-base-patch.png",
                    priority = "medium",
                    width = 138,
                    height = 100,
                    frame_count = 1,
