...
local function stack_inserter_remnants(name)
    ...
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/remnants/"..name.."-remnants.png",
        line_length = 1,
        width = 66,
        height = 50,
        frame_count = 1,
        ...
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/remnants/hr-"..name.."-remnants.png",
            line_length = 1,
            width = 132,
            height = 96,
            frame_count = 1,
...
local function hand_base_shadow()
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/hand-base-shadow.png",
        priority = "extra-high",
        width = 8,
        height = 33,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/hr-hand-base-shadow.png",
            priority = "extra-high",
            width = 32,
            height = 132,
            scale = 0.25
...
local function inserter_hand_closed_shadow()
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/inserter/inserter-hand-closed-shadow.png",
        priority = "extra-high",
        width = 18,
        height = 41,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/inserter/hr-inserter-hand-closed-shadow.png",
            priority = "extra-high",
            width = 72,
            height = 164,
            scale = 0.25
...
local function stack_inserter_hand_closed_shadow()
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/stack-inserter/stack-inserter-hand-closed-shadow.png",
        priority = "extra-high",
        width = 24,
        height = 41,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/stack-inserter/hr-stack-inserter-hand-closed-shadow.png",
            priority = "extra-high",
            width = 100,
            height = 164,
            scale = 0.25
...
local function inserter_hand_open_shadow()
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/inserter/inserter-hand-open-shadow.png",
        priority = "extra-high",
        width = 18,
        height = 41,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/inserter/hr-inserter-hand-open-shadow.png",
            priority = "extra-high",
            width = 72,
            height = 164,
            scale = 0.25
...
local function stack_inserter_hand_open_shadow()
    return
    {
      filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/stack-inserter/stack-inserter-hand-open-shadow.png",
      priority = "extra-high",
      width = 32,
      height = 41,
      hr_version =
      {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/base/stack-inserter/hr-stack-inserter-hand-open-shadow.png",
        priority = "extra-high",
        width = 130,
        height = 164,
        scale = 0.25
...
local function inserter_hand_base_picture(name)
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/"..name.."-hand-base.png",
        priority = "extra-high",
        width = 8,
        height = 33,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/hr-"..name.."-hand-base.png",
            priority = "extra-high",
            width = 32,
            height = 136,
            scale = 0.25
...
local function inserter_hand_closed_picture(name)
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/"..name.."-hand-closed.png",
        priority = "extra-high",
        width = 18,
        height = 41,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/hr-"..name.."-hand-closed.png",
            priority = "extra-high",
            width = 72,
            height = 164,
            scale = 0.25
...
local function inserter_hand_open_picture(name)
    return
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/"..name.."-hand-open.png",
        priority = "extra-high",
        width = 18,
        height = 41,
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/hr-"..name.."-hand-open.png",
            priority = "extra-high",
            width = 72,
            height = 164,
            scale = 0.25
...
local function inserter_platform_picture(name)
    return
    {
        sheet =
        {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/"..name.."-platform.png",
            priority = "extra-high",
            width = 46,
            height = 46,
            shift = {0.09375, 0},
            hr_version =
            {
            filename = inputs.directory.."/graphics/entity/structures/logistics/inserter/"..name.."/hr-"..name.."-platform.png",
            priority = "extra-high",
            width = 105,
            height = 79,
