...
for name, map in pairs(tier_map) do
    ...
    entity.base =
    {
        layers =
        {
            -- Base
            {
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/hr-zone-expander-base.png",
                    width = 56,
                    height = 142,
                    shift = util.by_pixel(0, -25.5),
                    scale = 0.5
            ...
            -- Grid
            {
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/grids/hr-grid-"..subtier..".png",
                    width = 56,
                    height = 142,
                    shift = util.by_pixel(0, -25.5),
                    scale = 0.5
            ...
            -- Metal
            {
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/metal/hr-metal-"..subtier..".png",
                    width = 56,
                    height = 142,
                    shift = util.by_pixel(0, -25.5),
                    scale = 0.5
            ...
            -- Mask
            {
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/hr-zone-expander-mask.png",
                    width = 56,
                    height = 142,
                    shift = util.by_pixel(0, -25.5),
                    tint = inputs.tint,
            ...
            -- Highlights
            {
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/hr-zone-expander-highlights.png",
                    width = 56,
                    height = 142,
                    shift = util.by_pixel(0, -25.5),
                    blend_mode = "additive",
            ...
            -- Shadow Fix (we'll do a proper fix later...)
            {
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/hr-zone-expander-shadow-fix.png",
                    width = 56,
                    height = 142,
                    shift = util.by_pixel(0, -25.5),
                    draw_as_shadow = true,
    ...
    entity.base_animation =
    {
        layers = 
        {
            ...
            -- Shadow
            {
                filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/zone-expander-shadow.png",
                width = 95,
                height = 30,
                frame_count = 8,
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-expander/hr-zone-expander-shadow.png",
                    width = 190,
                    height = 60,
                    frame_count = 8,
                    shift = util.by_pixel(48, 0),
