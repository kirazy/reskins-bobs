...
entity.base =
{
    filename = inputs.directory.."/graphics/entity/structures/logistics/zone-interface/logistic-zone-interface.png",
    width = 32,
    height = 35,
    shift = util.by_pixel(0, -4),
    hr_version =
    {
        filename = inputs.directory.."/graphics/entity/structures/logistics/zone-interface/hr-logistic-zone-interface.png",
        width = 64,
        height = 70,
        shift = util.by_pixel(0, -4),
        scale = 0.5,
...
entity.base_animation =
{
    ...
    {
        {            
            filename = inputs.directory.."/graphics/entity/structures/logistics/roboport/base/antennas/roboport-1-base-animation.png",
            priority = "medium",
            width = 42,
            height = 31,
            frame_count = 8,
        ...
        {            
            filename = inputs.directory.."/graphics/entity/structures/logistics/zone-interface/logistic-zone-interface-shadow.png",
            priority = "medium",
            width = 53,
            height = 35,
            frame_count = 8,
            ...
            hr_version =
            {
                filename = inputs.directory.."/graphics/entity/structures/logistics/zone-interface/hr-logistic-zone-interface-shadow.png",
                priority = "medium",
                width = 106,
                height = 69,
                frame_count = 8,
