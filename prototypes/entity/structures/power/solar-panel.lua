...
for name, tier in pairs(tier_map) do
    ...
    -- Reskin remnants
    -- remnant.animation[1].filename = inputs.directory.."/graphics/entity/structures/power/"..inputs.root_name.."/"..inputs.internal_name.."/remnants/"..inputs.internal_name.."-remnants.png"
    -- remnant.animation[1].hr_version.filename = inputs.directory.."/graphics/entity/structures/power/"..inputs.root_name.."/"..inputs.internal_name.."/remnants/hr-"..inputs.internal_name.."-remnants.png"
    -- remnant.animation[2].filename = inputs.directory.."/graphics/entity/structures/power/"..inputs.root_name.."/"..inputs.internal_name.."/remnants/"..inputs.internal_name.."-remnants.png"
    -- remnant.animation[2].hr_version.filename = inputs.directory.."/graphics/entity/structures/power/"..inputs.root_name.."/"..inputs.internal_name.."/remnants/hr-"..inputs.internal_name.."-remnants.png"
    ...
    if inputs.root_name == "solar-panel-small" then
            ...
            {
                {
                    ...
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-small/base/hr-solar-panel-small.png",
                        priority = "high",
                        width = 180,
                        height = 150,
                ...
                },
                {
                    ...
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-small/base/hr-solar-panel-small-shadow.png",
                        priority = "high",
                        width = 180,
                        height = 150,
                        shift = util.by_pixel(5, 0.5),
        ...
        entity.overlay = 
        {
            ...
            {
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-small/base/solar-panel-small-shadow-overlay.png",
                    priority = "high",
                    width = 90,
                    height = 75,
                    shift = util.by_pixel(2.5, 0.25),
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-small/base/hr-solar-panel-small-shadow-overlay.png",
                        priority = "high",
                        width = 180,
                        height = 150,
                        shift = util.by_pixel(5, 0.5),
    ...
    elseif inputs.root_name == "solar-panel-large" then
            ...
            {
                {
                    ...
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-large/base/hr-solar-panel-large.png",
                        priority = "high",
                        width = 308,
                        height = 274,
                ...
                },
                {
                    ...
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-large/base/hr-solar-panel-large-shadow.png",
                        priority = "high",
                        width = 308,
                        height = 274,
                        shift = util.by_pixel(5, 3.5),
        ...
        entity.overlay = 
        {
            ...
            {
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-large/base/solar-panel-large-shadow-overlay.png",
                    priority = "high",
                    width = 154,
                    height = 137,
                    shift = util.by_pixel(2.5, 1.75),
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/solar-panel-large/base/hr-solar-panel-large-shadow-overlay.png",
                        priority = "high",
                        width = 308,
                        height = 274,
                        shift = util.by_pixel(5, 3.5),
