...
local function skin_reactor_icon(name, tier, inputs)
    ...
    {
        {
            icon = inputs.directory.."/graphics/icons/structures/power/nuclear-reactor/base/icon-"..inputs.fuel.."-base.png"
        },
        {
            icon = inputs.directory.."/graphics/icons/structures/power/nuclear-reactor/reactor-icon-mask.png",
            tint = inputs.tint
        },
        {
            icon = inputs.directory.."/graphics/icons/structures/power/nuclear-reactor/reactor-icon-highlights.png",
            blend_mode = "additive",
        },
        {
            icon = inputs.directory.."/graphics/icons/structures/power/nuclear-reactor/pipes/icon-piping-"..inputs.pipe_tier..".png"
        },
        {
            icon = inputs.directory.."/graphics/icons/structures/power/nuclear-reactor/fuel/icon-"..inputs.fuel.."-glow.png"
        }        
    }
...
local function skin_reactor_entity(name, inputs)
    ...
    entity.picture =
    {
        layers =
        {
            ...
            -- Mask
            {
                filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/reactor-mask.png",
                width = 154,
                height = 158,
                shift = util.by_pixel(-6, -6),
                tint = inputs.tint,
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/hr-reactor-mask.png",
                    width = 302,
                    height = 318,
                    scale = 0.5,
                    shift = util.by_pixel(-5, -7),
            ...
            -- Highlights
            {
                filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/reactor-highlights.png",
                width = 154,
                height = 158,
                shift = util.by_pixel(-6, -6),
                blend_mode = "additive",
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/hr-reactor-highlights.png",
                    width = 302,
                    height = 318,
                    scale = 0.5,
                    shift = util.by_pixel(-5, -7),
            ...
            -- Pipes
            {
                filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/pipes/reactor-piping-"..inputs.pipe_tier..".png",
                width = 154,
                height = 158,
                shift = util.by_pixel(-6, -6),
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/pipes/hr-reactor-piping-"..inputs.pipe_tier..".png",
                    width = 302,
                    height = 318,
                    scale = 0.5,
                    shift = util.by_pixel(-5, -7),
    ...
    {
        filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/pipes/reactor-base-pipes-"..inputs.pipe_tier..".png",
        width = 156,
        height = 156,
        shift = util.by_pixel(-2, -4),
        hr_version =
        {
            filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/pipes/hr-reactor-base-pipes-"..inputs.pipe_tier..".png",
            width = 320,
            height = 316,
            scale = 0.5,
    ...
    entity.connection_patches_connected =
    {
        sheet =
        {
            filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/pipes/reactor-connect-patches-"..inputs.pipe_tier..".png",
            width = 32,
            height = 32,
            variation_count = 12,
            hr_version =
            {
                filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/pipes/hr-reactor-connect-patches-"..inputs.pipe_tier..".png",
                width = 64,
                height = 64,
                variation_count = 12,
                scale = 0.5
...
local function skin_reactor_remnants(name, inputs)
    ...
    remnant.animation =
    {
        layers =
        {
            ...
            -- Mask
            {
                    filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/remnants/nuclear-reactor-remnants-mask.png",
                    line_length = 1,
                    width = 206,
                    height = 198,
                    frame_count = 1,
                    ...
                    hr_version =
                    {
                        filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/remnants/hr-nuclear-reactor-remnants-mask.png",
                        line_length = 1,
                        width = 410,
                        height = 396,
                        frame_count = 1,
            ...
            -- Highlights
            {
                filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/remnants/nuclear-reactor-remnants-highlights.png",
                line_length = 1,
                width = 206,
                height = 198,
                frame_count = 1,
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/remnants/hr-nuclear-reactor-remnants-highlights.png",
                    line_length = 1,
                    width = 410,
                    height = 396,
                    frame_count = 1,
            ...
            -- Pipes
            {
                filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/remnants/pipes/reactor-piping-"..inputs.pipe_tier.."-remnants.png",
                line_length = 1,
                width = 206,
                height = 198,
                frame_count = 1,
                ...
                hr_version =
                {
                    filename = inputs.directory.."/graphics/entity/structures/power/nuclear-reactor/remnants/pipes/hr-reactor-piping-"..inputs.pipe_tier.."-remnants.png",
                    line_length = 1,
                    width = 410,
                    height = 396,
                    frame_count = 1,
