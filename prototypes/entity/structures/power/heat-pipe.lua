...
for name, tier in pairs(tier_map) do
    ...
    -- Reskin remnants
    -- remnant.animation.filename = inputs.directory.."/graphics/entity/structures/power/"..inputs.folder.."/"..inputs.internal_name.."/remnants/"..inputs.internal_name.."-remnants.png"
    -- remnant.animation.hr_version.filename = inputs.directory.."/graphics/entity/structures/power/"..inputs.folder.."/"..inputs.internal_name.."/remnants/hr-"..inputs.internal_name.."-remnants.png"
    
    -- Reskin entities
    if name ~= "heat-pipe" then
        entity.connection_sprites = make_heat_pipe_pictures(inputs.directory.."/graphics/entity/structures/power/heat-pipe/"..inputs.internal_name.."/", inputs.internal_name,
        {
