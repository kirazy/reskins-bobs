...
for name, map in pairs(steel_furnace_map) do
    ...
    -- Prepend oil prefix when working with oil-based furnaces
    if string.find(name, "oil") then
    ...
    if string.find(name, "chemical") then
        if string.find(name, "oil") then
            -- Skin the oil-based chemical furnace working visualization
            entity.working_visualisations = {
                -- Fire effect
                {
                    position = {0, 0},                    
    ...
    elseif string.find(name, "oil") then
        -- Skin the oil-based non-chemical furncace working visualizations
        entity.working_visualisations = {
            -- Fire effect
            {
                position = {0, 0},                    
...
-- electric-furnace-2
-- electric-furnace-3
-- chemical-furnace                        -- Chemical Electric
