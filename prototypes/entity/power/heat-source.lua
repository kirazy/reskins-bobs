...
local tier_map = {
    ["burner-reactor"] = {tier = 1, prog_tier = 2, icon_name = "heat-source-burner"},
    ["burner-reactor-2"] = {tier = 2, prog_tier = 3, icon_name = "heat-source-burner"},
    ["fluid-reactor"] = {tier = 1, prog_tier = 2, icon_name = "heat-source-fluid"},
    ["fluid-reactor-2"] = {tier = 2, prog_tier = 3, icon_name = "heat-source-fluid"},
}
