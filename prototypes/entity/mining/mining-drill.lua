...
local function vertical_drill_animation(speed, inputs)
    return
    {
        layers = {
            ...
            {
                priority = "high",
                filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/electric-mining-drill-mask.png",
                line_length = 6,
                width = 98,
                height = 80,
                frame_count = 30,
                ...
                hr_version = {
                    priority = "high",
                    filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/hr-electric-mining-drill-mask.png",
                    line_length = 6,
                    width = 194,
                    height = 154,
                    frame_count = 30,
            ...
            {
                priority = "high",
                filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/electric-mining-drill-highlights.png",
                line_length = 6,
                width = 98,
                height = 80,
                frame_count = 30,
                ...
                hr_version = {
                    priority = "high",
                    filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/hr-electric-mining-drill-highlights.png",
                    line_length = 6,
                    width = 194,
                    height = 154,
                    frame_count = 30,
    ...
    if is_front then
        ...
        drill_animation = {
            layers = {
                ...
                {
                    priority = "high",
                    filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/electric-mining-drill-horizontal-front-mask.png",
                    line_length = 6,
                    width = 28,
                    height = 66,
                    frame_count = 30,
                    ...
                    hr_version = {
                        priority = "high",
                        filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/hr-electric-mining-drill-horizontal-front-mask.png",
                        line_length = 6,
                        width = 54,
                        height = 136,
                        frame_count = 30,
                ...
                {
                    priority = "high",
                    filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/electric-mining-drill-horizontal-front-highlights.png",
                    line_length = 6,
                    width = 28,
                    height = 66,
                    frame_count = 30,
                    ...
                    hr_version = {
                        priority = "high",
                        filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/hr-electric-mining-drill-horizontal-front-highlights.png",
                        line_length = 6,
                        width = 54,
                        height = 136,
                        frame_count = 30,
        ...
        drill_animation = {
            layers = {
                ...
                {
                    priority = "high",
                    filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/electric-mining-drill-horizontal-mask.png",
                    line_length = 6,
                    width = 54,
                    height = 92,
                    frame_count = 30,
                    ...
                    hr_version = {
                        priority = "high",
                        filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/hr-electric-mining-drill-horizontal-mask.png",
                        line_length = 6,
                        width = 104,
                        height = 178,
                        frame_count = 30,
                ...
                {
                    priority = "high",
                    filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/electric-mining-drill-horizontal-highlights.png",
                    line_length = 6,
                    width = 54,
                    height = 92,
                    frame_count = 30,
                    ...
                    hr_version = {
                        priority = "high",
                        filename = inputs.directory.."/graphics/entity/mining/mining-drill/drill/hr-electric-mining-drill-horizontal-highlights.png",
                        line_length = 6,
                        width = 104,
                        height = 178,
                        frame_count = 30,
...
local function drill_dry_animation(speed, inputs)
    ...
    if inputs.is_area_drill then
        drill_type = inputs.directory.."/graphics/entity/mining/mining-drill/area-frame"
    end
        ...
        -- Fluid Window Background (Bottom)
        {
            ...
            north_animation = {
                layers = {
                    {
                        priority = "high",
                        filename = "__base__/graphics/entity/electric-mining-drill/electric-mining-drill-N-wet-window-background-front.png",
                        line_length = 1,
                        width = 68,
                        height = 14,
                        frame_count = 1,
                        ...
                        hr_version = {
                            priority = "high",
                            filename = "__base__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N-wet-window-background-front.png",
                            line_length = 1,
                            width = 132,
                            height = 28,
                            frame_count = 1,
        ...
        -- Fluid Base (Bottom)
        {
            ...
            north_animation = {
                layers = {
                    {
                        priority = "high",
                        filename = "__base__/graphics/entity/electric-mining-drill/electric-mining-drill-N-wet-fluid-background-front.png",
                        line_length = 1,
                        width = 66,
                        height = 20,
                        frame_count = 1,
                        ...
                        hr_version = {
                            priority = "high",
                            filename = "__base__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N-wet-fluid-background-front.png",
                            line_length = 1,
                            width = 130,
                            height = 36,
                            frame_count = 1,
        ...
        -- Fluid Flow (Bottom)
        {
            ...
            north_animation = {
                layers = {
                    {
                        priority = "high",
                        filename = "__base__/graphics/entity/electric-mining-drill/electric-mining-drill-N-wet-fluid-flow-front.png",
                        line_length = 1,
                        width = 66,
                        height = 16,
                        frame_count = 1,
                        ...
                        hr_version = {
                            priority = "high",
                            filename = "__base__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N-wet-fluid-flow-front.png",
                            line_length = 1,
                            width = 130,
                            height = 28,
                            frame_count = 1,
