...
local laser_defense = {
    ["vehicle-laser-defense-1"] = { tier = 0 },
    ["vehicle-laser-defense-2"] = { tier = 1 },
    ["vehicle-laser-defense-3"] = { tier = 2 },
    ["vehicle-laser-defense-4"] = { tier = 3 },
    ["vehicle-laser-defense-5"] = { tier = 4 },
    ["vehicle-laser-defense-6"] = { tier = 5 },
}
