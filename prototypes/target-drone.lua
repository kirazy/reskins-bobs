...
target_drone_item.name = "target-drone"
target_drone_item.place_result = "target-drone"
target_drone_item.flags = {"hidden"}
target_drone_item.icon = reskins.bobs_structures.directory.."/graphics/target-drone/target-drone-icon.png"
...
target_drone_remnant.name = "target-drone-remnants"
target_drone_remnant.icon = reskins.bobs_structures.directory.."/graphics/target-drone/target-drone-icon.png"
...
{
    filename = reskins.bobs_structures.directory.."/graphics/target-drone/remnants/target-drone-remnants.png",
    line_length = 1,
    width = 58,
    height = 58,
    frame_count = 1,
    ...
    hr_version =
    {
        filename = reskins.bobs_structures.directory.."/graphics/target-drone/remnants/hr-target-drone-remnants.png",
        line_length = 1,
        width = 116,
        height = 114,
        frame_count = 1,
...
target_drone.name = "target-drone"
target_drone.max_health = settings.startup["reskin-series-target-drone-health"].value
target_drone.flags = {"placeable-enemy", "placeable-off-grid", "not-on-map", "hidden"}
target_drone.icon = reskins.bobs_structures.directory.."/graphics/target-drone/target-drone-icon.png"
target_drone.icon_size = 64
target_drone.icon_mipmaps = 4
target_drone.energy_per_tick = "0.00kJ"
target_drone.idle =
{
    filename = reskins.bobs_structures.directory.."/graphics/target-drone/target-drone.png",
    priority = "high",
    line_length = 16,
    width = 41,
    height = 42,
    ...
    hr_version =
    {
        filename = reskins.bobs_structures.directory.."/graphics/target-drone/hr-target-drone.png",
        priority = "high",
        line_length = 16,
        width = 80,
        height = 84,
...
target_drone = data.raw["logistic-robot"]["target-drone"]
...
target_drone_dying_particle =
{
    ...
    name = "target-drone-dying-particle",
...
target_drone.dying_trigger_effect =
{
    {
        type = "create-particle",
        particle_name = "target-drone-dying-particle",
        initial_height = 1.8,
