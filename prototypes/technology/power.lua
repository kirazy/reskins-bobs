...
local technologies = {
    ...
    -- Nuclear reactors
    ["nuclear-power"] = {tier = 1, prog_tier = 3, icon_name = "nuclear-power"}, -- t3 reactor
    ["bob-nuclear-power-2"] = {tier = 2, prog_tier = 4, icon_name = "nuclear-power"}, -- t4 reactor
    ["bob-nuclear-power-3"] = {tier = 3, prog_tier = 5, icon_name = "nuclear-power"}, -- t5 reactor
}

-- Nuclear power glow and pipe determination
